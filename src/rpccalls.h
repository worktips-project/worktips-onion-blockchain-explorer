...
#ifndef CROWWTIP_RPCCALLS_H
#define CROWWTIP_RPCCALLS_H
...
{
// declare struct in worktips's cryptonote namespace.
// worktips should provide definition for this,
